...
int main(int argc, char* argv[]) {
  ...
  std::cout << "FEND v" << PROJECT_VERSION << " Poolwallet" << std::endl;

  std::cout << "Please note that usage of simplewallet/poolwallet has been "
            << "deprecated for pool usage." << std::endl
            << "If you are using fend-pool, you can trivially transfer to "
            << "services by following these instructions:" << std::endl
            << "https://github.com/turtlecoin/turtle-pool/pull/5  ?? will recheck this later" << std::endl;
